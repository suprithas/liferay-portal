...
public interface WeDeployAuthAppPersistence extends BasePersistence<WeDeployAuthApp> {
	...
	/**
	* Returns the we deploy auth app where companyId = &#63; or throws a {@link NoSuchWeDeployAuthAppException} if it could not be found.
	*
	* @param companyId the company ID
	* @return the matching we deploy auth app
	* @throws NoSuchWeDeployAuthAppException if a matching we deploy auth app could not be found
	*/
	...
	*/
	...
	/**
	* Returns the we deploy auth app where clientId = &#63; or throws a {@link NoSuchWeDeployAuthAppException} if it could not be found.
	*
	* @param clientId the client ID
	* @return the matching we deploy auth app
	* @throws NoSuchWeDeployAuthAppException if a matching we deploy auth app could not be found
	*/
	public WeDeployAuthApp findByClientId(java.lang.String clientId)
		throws NoSuchWeDeployAuthAppException;
	...
	* @return the matching we deploy auth app, or <code>null</code> if a matching we deploy auth app could not be found
	*/
	public WeDeployAuthApp fetchByClientId(java.lang.String clientId);
	...
	* @return the we deploy auth app that was removed
	*/
	public WeDeployAuthApp removeByClientId(java.lang.String clientId)
		throws NoSuchWeDeployAuthAppException;
