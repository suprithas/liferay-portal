...
public class WeDeployAuthAppPersistenceTest {
	...
	@Test
	public void testCountByClientId() throws Exception {
		_persistence.countByClientId(StringPool.BLANK);

		_persistence.countByClientId(StringPool.NULL);

		_persistence.countByClientId((String)null);
	}
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertEquals(Long.valueOf(existingWeDeployAuthApp.getCompanyId()),
			ReflectionTestUtil.<Long>invoke(existingWeDeployAuthApp,
