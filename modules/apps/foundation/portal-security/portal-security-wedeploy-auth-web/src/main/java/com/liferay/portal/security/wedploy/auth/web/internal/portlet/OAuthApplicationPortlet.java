...
@Component(
	property = {
		...
		"javax.portlet.display-name=OAuth Application",
		"javax.portlet.expiration-cache=0",
		"javax.portlet.info.keywords=OAuth Application",
		"javax.portlet.info.short-title=OAuth Application",
		"javax.portlet.info.title=OAuth Application",
		"javax.portlet.init-param.clear-request-parameters=true",
		"javax.portlet.init-param.copy-request-parameters=true",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/admin.jsp",
...
public class OAuthApplicationPortlet extends MVCPortlet {
